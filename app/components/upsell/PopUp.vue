        ...
        <Transition enter-active-class="transition-opacity duration-200" enter-from-class="opacity-0"
            ...
            <div class="fixed inset-0 z-[60] bg-black/50 flex items-center justify-center p-4" role="dialog"
                ...
                <Transition enter-active-class="transition-transform duration-200" enter-from-class="scale-95 opacity-0"
                    ...
                    <div class="relative max-w-[760px] w-full">
                        <div
                            class="popup border-dashed border-[#e6193c] border-3 p-[20px_5px_15px_5px] lg:p-[40px_40px_45px] mx-auto text-center max-w-[730px] rounded-[.5rem] bg-white">
                            ...
                            <h4 class="text-xl md:text-2xl extrablod my-3">
                                For the NEXT 3 MINUTES <u>ONLY</u>,<br />
                                <span>GET <span class="text-[#e6193c]">50% OFF</span></span><br />
                                <span>EXPEDITED SHIPPING!</span>
                            </h4>

                            <p class="text-md md:text-lg font-extrabold mb-3">
                                Tap below to get this exclusive <br />
                                <span><span class="extrablod">one time</span> offer</span><br />
                                for only <span class="text-[#e6193c]">$4.99!</span>
                            </p>
                            ...
                            <div class="flex flex-col">
                                ...
                                <div @click="() => importUpsell(productDetails)" v-if="!checkoutStore.transactionStatus"
                                    class="relative inline-block lg:mt-5 mt-3 mx-auto w-fit rounded-full bg-[#1EB9F0] select-none cursor-pointer">
                                    <span
                                        class="relative block text-[#1EB9F0] bg-white border border-[#1EB9F0] rounded-full py-[12px] lg:px-[40px] px-[20px] text-[calc(1.2rem-0px)] lg:text-[calc(1.5rem-0px)] leading-[calc(1em+1vw)] extrablod translate-x-[-4px] translate-y-[-4px] transition-transform duration-250 hover:translate-x-[-7px] hover:translate-y-[-6px]">
                                ...
                                <!-- <div name="loader" v-if="checkoutStore.transactionStatus"
                                    class="bg-[#1EB9F0] py-[12px] px-[40px] lg:w-[40%] md:w-[60%] w-[80%] mx-auto flex justify-center items-center rounded-lg cursor-pointer text-pixel">
                                ...
                                <div @click=mayBeLater()
                                    class="popup text-black text-sm lg:text-lg font-bold underline mt-2 cursor-pointer">
                                    No thanks, don't expedite my order.
                                </div>
                            </div>
                        </div>
                    </div>
